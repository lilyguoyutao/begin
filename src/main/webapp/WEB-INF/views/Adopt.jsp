...
$(document).ready(function(){
	  ...
	  type:'GET',
	  url:'/CITIC/listcommunityname?projectid=${projectid}&threadname=${threadname}',
...
<body>
	<div
		...
		<form action="/CITIC/insertadopt" method="post">
			<p>
				Would you like to recommend &nbsp<a
					href="/CITIC/threadpage?projectid=${projectid}&threadname=${threadname}">${threadname}</a>
				to
			</p>
			<select id="select" name="community">

			</select> <input type="hidden" name="threadname" value="${threadname}">
