...
<%@ page import="Graph.sqls"%>
<%@ page import="Graph.Operatedb"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<title></title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<link href="resources/css/stickyhead.css" rel="stylesheet" type="text/css">
<link href="resources/css/screenLock.css" rel="stylesheet" type="text/css">
<link href="resources/css/itm_week_beta.css" rel="stylesheet" type="text/css">
<link href="resources/css/btn_link.css" rel=StyleSheet type="text/css">
<link href="resources/css/jquery-ui.css" rel="stylesheet" />
<link href="resources/css/jquery.qtip.min.css" rel="stylesheet" type="text/css">
<link href="resources/css/thread.css" rel="stylesheet" type="text/css">
<link href="resources/css/impress.css" rel="stylesheet" type="text/css">
<link href="resources/css/drawThreadGraph.css" rel="stylesheet" type="text/css">
...
<script src="resources/js/drawThreadGraph.js" type="text/javascript"></script>
<script src="resources/js/itm_week_beta.js" type="text/javascript"></script>
<script src="resources/js/screenLock.js" type="text/javascript"></script>
</head>
<%
	//传参
	String projectn = (String)request.getParameter("projectname");
...
<body class="impress-not-supported" style="overflow:hidden" onload="render()">
...
<!-- -----显示node的信息------ -->
		...
		%>
			<div class="rawnote" highlight="<%=highlighted %>" noteid="<%=disrs.getString(1)%>" view="" author="" firstn="" date="<%=disrs.getString(4)%>">
